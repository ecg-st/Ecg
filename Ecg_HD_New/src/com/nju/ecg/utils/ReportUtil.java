...
//        Bitmap image = Bitmap.createBitmap(EcgConst.DISPLAY_WIDTH, EcgConst.DISPLAY_HEIGH - infoHeight, Bitmap.Config.RGB_565);
    	Bitmap image = Bitmap.createBitmap(EcgConst.DISPLAY_WIDTH, EcgConst.DISPLAY_HEIGH, Bitmap.Config.RGB_565);
        Canvas canvas = new Canvas(image);
        new WaveDrawer(ch1Data, ch2Data, updateIndex, switchScreen).draw(canvas);
        return image;
    }
    ...
    public Bitmap drawDotGraph(String filePath, long collectingTime)
    {
        ...
        Canvas canvas = new Canvas(image);
        new DotGraphDrawer(filePath, collectingTime).draw(canvas);
        return image;
    }
    ...
    private class DotGraphDrawer
    {
        ...
        {
            new RRDotDrawer(rrX, rrY, collectingTime).draw(canvas);
        }
        ...
        {
            new HeartDotDrawer(heartX, heartY, collectingTime).draw(canvas);
        }
