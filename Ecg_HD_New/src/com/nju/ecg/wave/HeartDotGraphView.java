...
public class HeartDotGraphView extends View
{
    ...
    private void drawBackground(Canvas canvas)
    {
        ...
        canvas.drawText(getContext().getString(R.string.heart_exception_graph), (float)squareSide / 2 + MARGIN - textPaint.measureText(getContext().getString(R.string.heart_exception_graph)) / 2, MARGIN + 30, textPaint);
        textPaint.setTextSize(15);
        textPaint.setColor(Color.BLACK);
        canvas.drawText(getContext().getString(R.string.collect_time) + collectingTime / 1000f + "s", MARGIN + (float)squareSide / 2 - textPaint.measureText(getContext().getString(R.string.collect_time) + collectingTime / 1000f + "s") / 2, squareSide + MARGIN + 30, textPaint);
    }
