...
public class RRDotGraphView extends View
{
    ...
    private void drawBackground(Canvas canvas)
    {
        ...
        canvas.drawText(getContext().getString(R.string.rr_graph), (float)squareSide / 2 + MARGIN + 10 - textPaint.measureText(getContext().getString(R.string.rr_graph)) / 2, MARGIN + 40, textPaint);
        textPaint.setTextSize(15);
        textPaint.setColor(Color.BLACK);
        canvas.drawText(getContext().getString(R.string.collect_time) + collectingTime / 1000f + "s", MARGIN + (float)squareSide / 2 + 10 - textPaint.measureText(getContext().getString(R.string.collect_time) + collectingTime / 1000f + "s") / 2, squareSide + MARGIN + 60, textPaint);
    }
