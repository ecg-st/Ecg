...
public class WidgetProviderMiddle extends AppWidgetProvider {
	@Override
	public void onUpdate(Context context, AppWidgetManager appWidgetManager,
        ...
        //通过RemoteViews添加单击事件
        RemoteViews remoteViews  = new RemoteViews(context.getPackageName(), R.layout.appwidget_provider_middle);                  
