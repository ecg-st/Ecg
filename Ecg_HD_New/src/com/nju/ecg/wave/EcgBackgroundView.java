...
public class EcgBackgroundView extends View
{
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        canvas.drawText(getContext().getString(R.string.mv_per_rect), 10, 20 , txt_paint);
        canvas.drawText(getContext().getString(R.string.s_per_rect), EcgConst.GRID_WIDTH * 5 * zoomRate, 20 , txt_paint);
        // 绘制背景
    ...
    void drawBackGround(Canvas canvas)
    {
        ...
        int gridWidth = EcgConst.GRID_WIDTH * zoomRate; 
