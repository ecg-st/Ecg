...
//                "displayDataCh2:" + Arrays.toString(displayDataCh2));
    ...
    private void drawLimbLead(Canvas canvas)
    {
        ...
        if (!switchScreen)
        {
            ...
            // Draw II
            oldX = EcgConst.DISPLAY_LEFT_LEAD_NUMBER_WIDTH;
            oldY = (int) (CENTER_Y_CH * 6 - marginBetweenWave - Y_AMPLIFIER2 * displayDataCh2[0] + Y_TUNING2);
            newY = 0;
            if (displayDataCh2[EcgConst.WAVE_DEVIATION_VALUE] != -1)
            {
                canvas.drawText("Ⅱ", TEXT_X_OFFSET, CENTER_Y_CH * 5 - marginBetweenWave, textPaint1);
            }
            for (int i = 0; i < updateCh1DataIndex + EcgConst.WAVE_DEVIATION_VALUE; i++)
            {
                newY = (int) (CENTER_Y_CH * 10 - marginBetweenWave - Y_AMPLIFIER2 * displayDataCh2[i] + Y_TUNING2);
            ...
            // Draw III
            oldX = EcgConst.DISPLAY_LEFT_LEAD_NUMBER_WIDTH;
            oldY = (int) (CENTER_Y_CH * 10 - marginBetweenWave * 2 - Y_AMPLIFIER3 * displayDataCh1[0] + Y_TUNING3);
            newY = 0;
            if (displayDataCh1[EcgConst.WAVE_DEVIATION_VALUE] != -1)
            {
                canvas.drawText("Ⅲ", TEXT_X_OFFSET, CENTER_Y_CH * 9 - marginBetweenWave * 2, textPaint2);
            }
            for (int i = 0; i < updateCh1DataIndex + EcgConst.WAVE_DEVIATION_VALUE; i++)
            {
                newY = (int) (CENTER_Y_CH * 14 - marginBetweenWave * 2 - Y_AMPLIFIER3 * displayDataCh1[i] + Y_TUNING3);
        ...
        else
        {
            // Draw AVR
            oldX = EcgConst.DISPLAY_LEFT_LEAD_NUMBER_WIDTH;
            oldY = (int) (CENTER_Y_CH * 2 - marginBetweenWave - Y_AMPLIFIER4 * (displayDataCh1[0] - 2 * displayDataCh2[0]) / 2 + Y_TUNING4);
            newY = 0;
            if (displayDataCh1[EcgConst.WAVE_DEVIATION_VALUE] != -1)
            {
                canvas.drawText("aVR", TEXT_X_OFFSET, CENTER_Y_CH - marginBetweenWave, textPaint0);
            }
            for (int i = 0; i < updateCh1DataIndex + EcgConst.WAVE_DEVIATION_VALUE; i++)
            {
                newY = (int) ( - marginBetweenWave - Y_AMPLIFIER4 * (displayDataCh1[i] - 2 * displayDataCh2[i]) / 2 + Y_TUNING4);
            ...
            // Draw AVL
            oldX = EcgConst.DISPLAY_LEFT_LEAD_NUMBER_WIDTH;
            oldY = (int) (CENTER_Y_CH * 6 - marginBetweenWave - Y_AMPLIFIER5 * (displayDataCh2[0] - 2 * displayDataCh1[0]) / 2 + Y_TUNING5);
            newY = 0;
            if (displayDataCh1[EcgConst.WAVE_DEVIATION_VALUE] != -1)
            {
                canvas.drawText("aVL", TEXT_X_OFFSET, CENTER_Y_CH * 5 - marginBetweenWave, textPaint1);
            }
            for (int i = 0; i < updateCh1DataIndex + EcgConst.WAVE_DEVIATION_VALUE; i++)
            {
                newY = (int) (CENTER_Y_CH * 4 - marginBetweenWave - Y_AMPLIFIER5 * (displayDataCh2[i] - 2 * displayDataCh1[i]) / 2 + Y_TUNING5);
            ...
            // Draw AVF
            oldX = EcgConst.DISPLAY_LEFT_LEAD_NUMBER_WIDTH;
            oldY = (int) (CENTER_Y_CH * 10 - marginBetweenWave * 2 - Y_AMPLIFIER6 * (displayDataCh1[0] + displayDataCh2[0]) / 2 + Y_TUNING6);
            newY = 0;
            if (displayDataCh1[EcgConst.WAVE_DEVIATION_VALUE] != -1)
            {
                canvas.drawText("aVF", TEXT_X_OFFSET, CENTER_Y_CH * 9 - marginBetweenWave * 2, textPaint2);
            }
            for (int i = 0; i < updateCh1DataIndex + EcgConst.WAVE_DEVIATION_VALUE; i++)
            {
                newY = (int) (CENTER_Y_CH * 14 - marginBetweenWave * 2 - Y_AMPLIFIER6 * (displayDataCh1[i] + displayDataCh2[i]) / 2 + Y_TUNING6);
    ...
    private void drawChestLead(Canvas canvas)
    {
        ...
        // Draw MV1
        oldX = EcgConst.DISPLAY_LEFT_LEAD_NUMBER_WIDTH;
        oldY = (int) (CENTER_Y_CH * 4 - Y_AMPLIFIER7 * displayDataCh1[0] + Y_TUNING7);
        newY = 0;
        if (displayDataCh1[EcgConst.WAVE_DEVIATION_VALUE] != -1)
        {
            canvas.drawText("MV1",
        ...
        for (int i = 0; i < updateCh1DataIndex + EcgConst.WAVE_DEVIATION_VALUE; i++)
        {
            newY = (int) (CENTER_Y_CH * 8 - Y_AMPLIFIER7 * displayDataCh1[i] + Y_TUNING7);
        ...
        // Draw MV5
        oldX = EcgConst.DISPLAY_LEFT_LEAD_NUMBER_WIDTH;
        oldY = (int) (CENTER_Y_CH * 8 - Y_AMPLIFIER8 * displayDataCh2[0] + Y_TUNING8);
        newY = 0;
        if (displayDataCh2[EcgConst.WAVE_DEVIATION_VALUE] != -1)
        {
            canvas.drawText("MV5",
        ...
        for (int i = 0; i < updateCh1DataIndex + EcgConst.WAVE_DEVIATION_VALUE; i++)
        {
            newY = (int) (CENTER_Y_CH * 12 - Y_AMPLIFIER8 * displayDataCh2[i] + Y_TUNING8);
